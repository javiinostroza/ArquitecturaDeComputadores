...
HD_PWD='C:/Users/Javiera/Documents/fulladder4/fulladder4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder4.tcl
