...
HD_PWD='C:/Users/Javiera/Documents/fulladder4/fulladder4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fulladder4.tcl -notrace
